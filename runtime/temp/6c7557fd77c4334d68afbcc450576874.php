<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/setting/button.html";i:1711863306;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form class="layui-row layui-col-space10 layui-form">
    <div class="layui-col-md12">
        <div class="layui-card" style="margin-left: 20px;margin-top: 20px;">
          ...
          <div class="layui-form-item">
            <label class="layui-form-label" style="width: 220px">是否启用Mp4</label>
            <div class="layui-input-inline">
              <select name="mp4_state" lay-verify="required" >
                <option value="open" <?php if($buttonSwitch['mp4_state'] == 'open'): ?>selected<?php endif; ?>>启用</option>
                <option value="close" <?php if($buttonSwitch['mp4_state'] == 'close'): ?>selected<?php endif; ?>>禁用</option>
              </select>
            </div>
          </div>
