<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/backend/view/index/index.html";i:1701061066;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
      ...
      <div class="layui-logo">
        <!-- 标 题 -->
        <div style="color:#ffffff;margin-left:-50px"><img class="logo" src="/static/admin/images/logo.png"></img>商户总后台管理</div>
      </div>
      <!-- 侧 边 菜 单 -->
