<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/index/index.html";i:1740935442;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <div id="control" class="layui-layout-control"></div>
      <li id="control" style="margin-top: 15px;text-align:center;margin-left:200px;margin-right:300px;color:#d8f125"><marquee>通知：/application/service/view/index/index.html修改本公告！</marquee></li>
  ...
  <div class="layui-side layui-bg-black">
    ...
    <div class="layui-logo">
      ...
      <img class="logo"></img>
      <!-- 标 题 -->
    <div style="color:#ffffff;">商户管理后台</div>
    </div>
    <!-- 侧 边 菜 单 -->
    <div class="layui-side-scroll">
      <div id="sideMenu"></div>
    </div>
    <div style="text-align:center"><p>客服系统：v4.0版本</p></div>
  </div>
  <!-- 视 图 页 面 -->
