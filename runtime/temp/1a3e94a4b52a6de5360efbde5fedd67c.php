<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/setting/access.html";i:1741707507;}*/ ?>
    ...
    <div class="front">
        <div class="my-setting">
                ...
                <div class="contents">
                    ...
                    <button class="layui-btn layui-btn-normal" onclick="build()">保存更新JS样式</button>
                ...
                <div class="layui-card-body">
                    <form class="layui-form" id="form-diy">
                           <div class="layui-form-item">
                            <label class="layui-form-label" style="width: 120px">图标样式</label>
                            <div class="layui-input-inline">
                                <input type="checkbox" checked name="isopen_win" lay-skin="switch" lay-filter="switchTest" lay-text="圆形|长体">
                            </div>
             ...
             success:function(res){
                 if(res.code == 0){
                     layer.msg(res.msg,{icon:1,end:function(){
                             ...
                             $('#ymwl-kefu').remove();
                             $('#wolive-talk').remove();
                             $('#blzxMinChatWindowDiv_yuan').remove();
