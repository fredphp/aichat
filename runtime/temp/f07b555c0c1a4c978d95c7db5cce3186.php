<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/cs.wmtao.xyz/public/../application/mobile/view/admin/index.html";i:1702467938;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8" />
    <title>朵米智能客服管理系统</title>
...
<h2 class="barTit barTitLg flex1 auto-play"><img class="logo" src="/static/admin/images/logo.png" width="30px" height="30px" top="30px" line-height="30px">&nbsp;&nbsp;客服后台&nbsp;&nbsp;</a>(<em style="color: #fff;"><?php echo $mine['user_name']; ?>)</em>
        ...
        <!-- //4个tabBar滑动切换 -->
        <div class="wc__swiper-tabBar flex1" style="margin-top: 1.2rem">
                    ...
                    <div class="swiper-slide"  data-history="my">
                        <div class="wc__scrolling-panel">
                            <div class="wc__ucenter-list" id="J__ucenterList">
                                <ul class="clearfix">
                                    <li>
                                        <div class="item flexbox flex-alignc wc__material-cell person-info" style="background: rgb(245, 108, 108)">
