<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/login/index.html";i:1742056119;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
  <title><?php echo (isset($business['business_name']) && ($business['business_name'] !== '')?$business['business_name']:"商户客服管理系统"); ?></title>
    ...
    <div class="signFlowHomePage-content">
     <div class="login">
        ...
        <div class="topLogoAndTitle">
            <div class="loginLogo"><img src="/assets/images/admin/newLogo.png" alt="登陆"></div>
            <h2 class="loginTitle">登录客服商户后台</span></h2>
        </div>
        <form class="layui-form login-bottom">
            ...
            <div class="loginBtn">
                <button lay-submit="" lay-filter="login">客服登录</button>
              <!--<a href="/service/login/reg"><p class="login-btn">免费注册</p></a>-->
            </div>


        </form>
        <div class="chooseLoginAndRegister"><span>没有帐号？<a  href="/service/login/reg">注册商户<span> &gt;&gt;</span></a></span>
