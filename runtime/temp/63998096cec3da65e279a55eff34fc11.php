<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/backend/view/busines/edit.html";i:1700817448;}*/ ?>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="lang">
                            ...
                            <?php $_67c99578c1b3d=config('lang'); if(is_array($_67c99578c1b3d) || $_67c99578c1b3d instanceof \think\Collection || $_67c99578c1b3d instanceof \think\Paginator): if( count($_67c99578c1b3d)==0 ) : echo "" ;else: foreach($_67c99578c1b3d as $key=>$vo): ?>
                 ...
                 <div class="layui-form-item">
                    <label class="layui-form-label">强制实名</label>
                    <div class="layui-input-block">
                        <select name="is_qiangzhi">
                            <option value="">请选择是否强制实名</option>
                            <option value="0" <?php if($business['is_qiangzhi'] == 0): ?>selected<?php endif; ?>>不强制实名</option>
                            <option value="1" <?php if($business['is_qiangzhi'] == 1): ?>selected<?php endif; ?>>强制实名</option>
                        </select>
                    </div>
                </div>
            </div>
