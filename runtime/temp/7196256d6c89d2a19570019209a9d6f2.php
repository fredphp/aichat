<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/setting/course.html";i:1702526416;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="layui-tab layui-tab-brief">
                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-card-body">
                                <h3>你可以在任何位置添加以下客服聊天链接，实现接入智能链接访问模式：</h3>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-card-body">
                                <h3>你可以在任何浏览器通过扫码，实现接入二维码访问模式：</h3>
                                <table class="layui-table">
                                    <thead>
                                    <tr>
                                        <th>客服名称</th>
