<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/robots/add.html";i:1742050349;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="mainBox">
        <div class="main-container">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="lang" lay-verify="required">
                        <?php $_67d594353e21a=config('lang'); if(is_array($_67d594353e21a) || $_67d594353e21a instanceof \think\Collection || $_67d594353e21a instanceof \think\Paginator): if( count($_67d594353e21a)==0 ) : echo "" ;else: foreach($_67d594353e21a as $key=>$vo): ?>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="keyword" value="" lay-verify="required" placeholder="请输入关键词 (最多10组,每组最多10个字)" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
