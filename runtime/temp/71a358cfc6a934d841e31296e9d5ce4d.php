<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/kkk.wmkf.xyz/public/../application/service/view/login/index.html";i:1701046374;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
    ...
    <div class="signFlowHomePage-content">
     <div class="login">
        ...
        <div class="topLogoAndTitle">
            ...
            <h2 class="loginTitle">登录在线客服系统<span>&amp;一站式接入全渠道</span></h2>
        </div>
