<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/mobile/view/index/index.html";i:1740840468;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<!--翻译功能-->
   ...
   <i class="el-icon-phone-outline" style="font-size: 22px;cursor: pointer;"></i></a >
    ...
    margin-bottom: 115px !important; margin-left: 0px"></ul>
                                        ...
                                        success:function(res){
                                          ...
                                          if(res.code != 0){
                                            ...
                                            //http://api.map.baidu.com/geocoder?location="+lat+","+lag+"&output=html&src=webapp.baidu.openAPIdemo'
                                                ...
                                                str += '<div style="position: absolute;right: 0px;"><img  class="my-circle cu_pic" src="' + pic + '" width="35px" height="35px"></div>';
                                              str += `<div class='outer-right'style="flex-direction: column;align-items: end" ><span style="color: #aca7a7;">${time}</span><div class='customer'>`;
                                              str += "<pre>";
