<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/cs.wmtao.xyz/public/../application/service/view/questions/edit.html";i:1636595572;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="lang" lay-verify="required">
                        <?php $_66065ed01ec1b=config('lang'); if(is_array($_66065ed01ec1b) || $_66065ed01ec1b instanceof \think\Collection || $_66065ed01ec1b instanceof \think\Paginator): if( count($_66065ed01ec1b)==0 ) : echo "" ;else: foreach($_66065ed01ec1b as $key=>$vo): ?>
