<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/mobile/view/admin/talk.html";i:1742115581;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
.chatmsg .chat-mp4{
   ...
   z-index: -9999999;
        ...
        .chatmsg .my-circle.se_pic{
            position: absolute;
            left: 0;
        }
        
        .chatmsg .my-circle.cu_pic{
            position: absolute;
            right: 0;
        }
                    ...
                    <a id="mp4" href="javascript:">
                      <form id="mp4Form" enctype="multipart/form-data">
                        <div class="layui-box input-but size">
                          ...
                          <input type="file" accept="video/*" name="mp4" class="fileinput" onchange="mp4Put()"/>
                        </div>
                      </form>
                    </a>
                            ...
                            $.ajax({
                                ...
                                success:function(res){
                                    if(res.code != 0){
                                        ...
                                        str = getOuterRight({cid:unstr,content:str,pic:imghead,time:formattingTime(myDate)})
