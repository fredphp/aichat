<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/kkk.wmkf.xyz/public/../application/service/view/banwords/index.html";i:1635394014;}*/ ?>
						...
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-inline">
								<select name="lang">
									...
									<?php $_6592c6066ccd2=config('lang'); if(is_array($_6592c6066ccd2) || $_6592c6066ccd2 instanceof \think\Collection || $_6592c6066ccd2 instanceof \think\Paginator): if( count($_6592c6066ccd2)==0 ) : echo "" ;else: foreach($_6592c6066ccd2 as $key=>$vo): ?>
