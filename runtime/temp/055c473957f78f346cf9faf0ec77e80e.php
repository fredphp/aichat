<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/setting/sentence_add.html";i:1703690946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="lang" lay-verify="required">
                        <?php $_67d677ebcd2fd=config('lang'); if(is_array($_67d677ebcd2fd) || $_67d677ebcd2fd instanceof \think\Collection || $_67d677ebcd2fd instanceof \think\Paginator): if( count($_67d677ebcd2fd)==0 ) : echo "" ;else: foreach($_67d677ebcd2fd as $key=>$vo): ?>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="service_id" lay-verify="required" plac>
                        ...
                        <option value="<?php echo $item['service_id']; ?>"><?php echo $item['nick_name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
