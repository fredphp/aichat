<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/kkk.wmkf.xyz/public/../application/service/view/robots/add.html";i:1636595608;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="lang" lay-verify="required">
                        <?php $_659402e760e9c=config('lang'); if(is_array($_659402e760e9c) || $_659402e760e9c instanceof \think\Collection || $_659402e760e9c instanceof \think\Paginator): if( count($_659402e760e9c)==0 ) : echo "" ;else: foreach($_659402e760e9c as $key=>$vo): ?>
