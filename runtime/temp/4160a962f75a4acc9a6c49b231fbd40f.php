<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/cs.wmtao.xyz/public/../application/layer/view/index/index.html";i:1711968628;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                                ...
                                //alert(result.address);
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(res){
                                            ...
                                            var str =   getOuterRight({content: locationmessage, time: formattingTime(new Date())})
