<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/kkk.wmkf.xyz/public/../application/service/view/index/index.html";i:1702467252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left">
      <li class="collaspe layui-nav-item"><a href="#" class="layui-icon layui-icon-prev"></a></li>
      <li class="refresh layui-nav-item"><a href="#" class="layui-icon layui-icon-refresh-1" loading=600></a></li>
       <li class="layui-nav-item layui-hide-xs"><a href="/mobile/admin" class="layui-icon layui-icon-cellphone-fine"></a></li>
    </ul>
    <!-- 顶 部 右 侧 菜 单 -->
    <div id="control" class="layui-layout-control"></div>
      <li id="control" style="margin-top: 15px;text-align:center;margin-left:200px;margin-right:300px;color:#d8f125"><marquee>通知：开通客服系统7日内，请在“左下角”提交您的实名信息，逾期未认证的商户将处于限制状态。禁止客服系统用于违规违法用途，一旦发现，我们有权删除账户，并不予退款，谢谢合作！</marquee></li>
    <ul class="layui-nav layui-layout-right" lay-filter="layui_nav_right">
      ...
      <li class="layui-nav-item layui-hide-xs">
        <a href="<?php echo url('index/index/welcome'); ?>" class="layui-icon layui-icon-template-1"></a>
      </li>
  ...
  <div class="layui-side layui-bg-black">
    ...
    <div class="layui-logo">
      ...
      <!-- 标 题 -->
    <div style="color:#ffffff;margin-left:-50px"><img class="logo" src="/static/admin/images/logo.png"></img>商户管理后台</div>
    </div>
    <!-- 侧 边 菜 单 -->
    <div class="layui-side-scroll">
      <div id="sideMenu"></div>
    </div>
    <div style="text-align:center"><p>朵米客服系统：v3.5版本</p></div>
  </div>
  <!-- 视 图 页 面 -->
...
<!-- 移 动 端 便 捷 操 作 -->
<div class="pear-collasped-pe collaspe"><a href="#" class="layui-icon layui-icon-prev"></a></div>
<!-- 加 载 动 画-->
...
<!-- 框 架 初 始 化 -->
<script>
    layui.use(['admin', 'jquery', 'layer','element','tab'], function() {
        var $ = layui.jquery;
