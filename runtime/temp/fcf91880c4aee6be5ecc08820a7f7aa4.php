<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/service/view/setting/index.html";i:1742050701;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-col-md12">
        <div class="layui-card" style="margin-left: 20px;margin-top: 20px;">
            ...
            <div class="layui-form-item" style="margin-top: 20px">
                ...
                <div class="layui-input-inline">
                    <select name="lang" lay-verify="required">
                        ...
                        <?php $_67d59597724cb=config('lang'); if(is_array($_67d59597724cb) || $_67d59597724cb instanceof \think\Collection || $_67d59597724cb instanceof \think\Paginator): if( count($_67d59597724cb)==0 ) : echo "" ;else: foreach($_67d59597724cb as $key=>$vo): ?>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">PC广告展示</label>
                <div class="layui-input-inline">
                    <select name="pctab" lay-verify="required" >
                        <option value="0" <?php if($business['pctab'] == 0): ?>selected<?php endif; ?>>常见问题</option>
                        <option value="1" <?php if($business['pctab'] == 1): ?>selected<?php endif; ?>>关于我们</option>
                    </select>
                </div>
            </div>
          <div class="layui-form-item">
            ...
            <div class="layui-form-item" style="margin-top: 20px">
                <label class="layui-form-label" style="width: 100px">客服在线提示消息:</label>
                <div class="layui-input-block">
                    <input name="ts1" value="<?php echo $business['ts1']; ?>" class="layui-input" style="width: 250px;display: inline-block;margin-right: 10px"/>
                    <span>(留空前台则不显示/)</span>
                </div>
            </div>
                                 <div class="layui-form-item" style="margin-top: 20px">
                <label class="layui-form-label" style="width: 100px">客服离线提示消息:</label>
                <div class="layui-input-block">
                    <input name="ts2" value="<?php echo $business['ts2']; ?>" class="layui-input" style="width: 250px;display: inline-block;margin-right: 10px"/>
                            <span>(留空前台则不显示)</span>
                </div>
            </div>
                                 <div class="layui-form-item" style="margin-top: 20px">
                <label class="layui-form-label" style="width: 100px">默认提示消息:</label>
                <div class="layui-input-block">
                    <input name="ts3" value="<?php echo $business['ts3']; ?>" class="layui-input" style="width: 250px;display: inline-block;margin-right: 10px"/>
                            <span>(留空前台则不显示)</span>
                </div>
            </div>
            <div class="layui-form-item" style="margin-top: 20px">
...
<script>
  function uploadChange(that){
    ...
    $("#div_buf").remove()
    $(that).parents(".layui-input-block").append(`<div id="div_buf" style="margin-left: 10px">${img.name}</div>`)
  }
