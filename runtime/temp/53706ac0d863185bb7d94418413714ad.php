<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/kf5.xywlgzs.vip/public/../application/layer/view/index/index.html";i:1741945067;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<!DOCTYPE html>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/hivideo.css">
    ...
    <script src="/assets/js/hivideo.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/libs/layui/css/layui.css?v=AI_KF">
        ...
        $(document).on("click", a);
            ...
            channels.bind('my-event', function (data) {
              ...
              data.message.time = formattingTime(date);
                ...
                if (au_state !== 'off') {
                  if (data.message.rule&&data.message.rule=='robot'){
                      sound.play();
    ...
    <div class="msg-bg" id="msg-bg-3"  	>
       ...
       <div class="msg-bg" id="msg-bg-4">
        <div class="dialog1" style="padding-bottom: 20px">
         ...
         <img id="lunbo_img" src="<?php echo $business_info['img1']; ?>"  style="width: 100%" >
          </div>
        </fieldset>
            <fieldset class="layui-elem-field">
          <legend>LOGO展示:</legend>
          <div class="layui-field-box">
  <img src="<?php echo $business_info['img1']; ?>"  style="width: 100%" />
          </div>
        </fieldset>
         <fieldset class="layui-elem-field">
          <legend>关于我们：</legend>
          <div class="layui-field-box">
              <p>  <?php echo $business_info['aboutus']; ?></p>
          </div>
        </fieldset>
        </div>
    </div>
...
<!-- 头部 -->
<div class="header" style="width: 100%;height: 65px;position: relative;background-color: #<?php echo $theme; ?>;top:-1.2rem;">
    <div class="infoBar" style="position: absolute;width: 100%;height: 100%">

        <img id="img_head" src="/assets/images/index/ai_service.png"  style="width: 45px;height: 45px;border-radius: 50%;position: absolute;left: 5px;top: 8px;" >
        <div style="display: flex;flex-direction: column;position: absolute;left: 58px;top: 50%;align-items: flex-start;transform: translate(0,-50%)">
        ...
        <!--<span style="position: absolute;left: 50%;top: 7px;height: 46px;line-height: 46px;color: #e9eae8;font-size: 12px;" id="onstaut">在线</span>-->
    ...
    font-size: 12px;">正在输入...</span>
        ...
        <?php if(!$ismoblie): ?>
        <a onclick="tanchuang()"  style="margin-top: 5px;cursor: pointer;    position: absolute;    right: 82px;    top: 5.6px;  cursor: pointer;font-size: 20px;color: #ffffff;">
            <i class="layui-icon layui-icon-screen-full" style="font-size: 23px;cursor: pointer;"></i>
        </a>
        <?php endif; ?>
        <a onclick="hint()" id="clickbf" style="margin-top: 5px;cursor: pointer;    position: absolute;    right: 52px;    top: 5.6px;  cursor: pointer;font-size: 20px;color: #ffffff;">
            <i class="layui-icon state-mp3" style="font-size: 23px;cursor: pointer;">&#xe645;</i>
        </a>
        <a onclick="tanchuang2()"  style="margin-top: 5px;cursor: pointer;    position: absolute;    right: 26px;    top: 5.6px;  cursor: pointer;font-size: 20px;color: #ffffff;">
            <i class="layui-icon layui-icon-close" style="font-size: 23px;cursor: pointer;"></i>
        </a><br>


<?php if($ismoblie && $buttonSwitch['tel_state'] == 'open'): ?>
<a onclick="location.href='tel:<?php echo $buttonSwitch['tel_state']; ?>'"
   style="margin-top: 5px;cursor: pointer; position: absolute; right: 90px;top: 6px; cursor: pointer;font-size: 20px;color: #fff;">
   <i class="el-icon-phone-outline" style="font-size: 23px;cursor: pointer;"></i>
</a >

<?php endif; ?>

        <!--- <a onclick="location.href='tel:1234567890'"
   style="margin-top: -37px;cursor: pointer; position: absolute; right: 90px; cursor: pointer;font-size: 14px;color: #fff;">
   <i class="layui-icon layui-icon-cellphone-fine" style="font-size: 20px;cursor: pointer;"></i>
</a >--->
    </div>
</div>

<div class="content" id="wrap" style="background-color: #f6f8f9;">
    <div style="height: 65px;width: 100%;"></div>
    <ul id="log" class="conversation"  style=" margin-bottom: 115px !important;"></ul>
...
<div style="position: relative; border-top: 0.5px solid #d9dbde;">
        <div class="hotQuestion" id="question_key_list">
    ...
    <div class="foot_msg"  id="foot_msg_one"   >
        ...
        <div class="footer" style="display:flex;">
            ...
            <div class="iconBtns visitorIconBox">
                <div class="el-tooltip iconfont icon-xiaolian  visitorIconBtns visitorFaceBtn" aria-describedby="el-tooltip-1829" onclick="faceon()" tabindex="0" style="font-size: 25px;"></div>

                   <?php if($buttonSwitch['voice_state'] == 'open'): ?>
             <div class="el-tooltip iconfont icon-mic  visitorIconBtns visitorFaceBtn" aria-describedby="el-tooltip-1829"onclick="recOpen()" tabindex="0" style="font-size: 25px;">

             </div>
              <?php endif; if($buttonSwitch['photo_state'] == 'open'): ?>
                        <div  class="el-icon-picture  visitorIconBtns visitorFaceBtn" aria-describedby="el-tooltip-1829"  tabindex="0" style="position: relative;font-size: 25px;" id="images1">
                        </div>
              <?php endif; ?>
             <div class="el-icon-plus btn-showtool" aria-describedby="el-tooltip-7589" tabindex="0" style="font-size: 24px;"></div>
              ...
              <input type="text"  placeholder="留下电话来电回访" class="el-input__inner"  id= "phone1" style="width: 150px;height:29px !important; margin-left: 16px; margin-right: 3px;  margin-top: 5px;line-height:1">
    ...
    <i class="el-icon-position" style="transform: scale(1);"></i></button>
       ...
       <div class="visitorEditor">
           <div id="msg-input" class="visitorEditorArea el-textarea">
         <textarea autocomplete="off"  id="text_in" maxlength="1000" rows="6" class="el-textarea__inner" style="resize: none; min-height: 100px; height: 73px;"  <?php if(!$ismoblie): ?>
             placeholder='# 请输入内容...'
             <?php else: ?> placeholder="# 请输入内容..."
         <?php endif; ?>></textarea></div> 
         
         <?php if(!$ismoblie): ?>
        <div class="visitorEditorBtn"style="color:#3232322e;right:unset;left:5px; font-size: 12px;"> <i class="el-icon-upload" style="font-size: 16px;"></i> <i>拖动图片/文件上传& Enter键发送消息</i></div>
        <?php endif; ?>
        
         <button  type="button" class="el-button visitorEditorBtn el-button--primary el-button--mini " style="background-color: #<?php echo $theme; ?>; border-color: #<?php echo $theme; ?>;" onclick="send()"><span><?php echo $lang['send']; ?> (s)</span></button>
...
<?php endif; if($buttonSwitch['mp4_state'] == 'open'): ?>
        <div id="uploadMp4" class="iconExtendBtn">
          <a id="mp4" href="javascript:" style="padding: 6px 0;">
            <form id="mp4Form" enctype="multipart/form-data">
              <img class="layui-img-icon" alt="" src="/assets/images/icon/sp.png">
              <div class="layui-box input-but size" style="width: 0 !important;">

                <input type="file" id="mp4Input" accept="video/*" name="mp4" class="fileinput" style="display: none;" onchange="mp4Put()" />
              </div>
            </form>
          </a>
          <div>视频</div>
...
<!--	<div class="iconExtendBtn">
	    ...
	    <?php if($buttonSwitch['location_state'] == 'open'): ?>
	<div class="iconExtendBtn" onclick="get_location()">

                    <div class="tool-icon" >
                        <img class="layui-img-icon" alt="" src="/assets/images/icon/wz.png">
                        <!-- <i class="layui-icon " style="font-size: 30px;font-weight: 500;cursor: pointer;color: #999"></i> -->
                    </div>
                    <div style="margin-bottom: -8px; margin-top: 5px;" class="tool-txt">位置</div>
  ...
  <div class="iconExtendBtn" onclick="zhuanrengong(<?php echo $business_id; ?>)">
	 <img class="layui-img-icon" alt="" src="/assets/images/icon/zrg.png">
		<div style="margin-bottom: -9px; margin-top: 5px;">转人工</div>
	</div>
<?php endif; if($buttonSwitch['leave_message_state'] == 'open'): ?>
	<div class="iconExtendBtn" onclick="msg()">
		...
		<div style="margin-bottom: -9px; margin-top: 5px;">留言</div>
	</div>
<?php endif; if($buttonSwitch['message_log_state'] == 'open'): ?>
    <div class="iconExtendBtn" id="exportchat" >

		<img class="layui-img-icon" alt="" src="/assets/images/icon/xx.png">
		<div style="margin-bottom: -9px; margin-top: 5px;"><a style="padding: 6px 10;color:#9fa19f;" target="_blank" href="" alt="下载聊天记录">消息记录</a></div>
	</div>
<?php endif; if($buttonSwitch['translators_state'] == 'open'): ?>
	<div class="iconExtendBtn" id="lang">
		...
		<div style="margin-bottom: -9px; margin-top: 5px;">翻译</div>
	</div>
...
<div class="iconExtendBtn" onclick="tc('<?php echo $buttonSwitch['wx_url']; ?>')">
		...
		<div style="margin-bottom: -9px; margin-top: 5px;">微信</div>
	</div>
<?php endif; if($buttonSwitch['wx_state'] == 'open'): ?>
	<div class="iconExtendBtn" onclick="tc('<?php echo $buttonSwitch['qq_url']; ?>')">
		...
		<div style="margin-bottom: -9px; margin-top: 5px;">QQ</div>
  </div>
<?php endif; if($buttonSwitch['link_state'] == 'open'): ?>
	<div class="iconExtendBtn" onclick=""><a href="<?php echo $buttonSwitch['link_url']; ?>" class="btn btn-common" target="_blank">
		...
		<div style="margin-bottom: -9px; margin-top: 5px;color: #9fa19f;"><?php echo $buttonSwitch['link_text']; ?></div></a>
	</div>
<?php endif; ?>
	<div class="iconExtendBtn" onclick="openComment()">
		    <img class="layui-img-icon" alt="" src="/assets/images/icon/pj.png">
		<div style="margin-bottom: -9px; margin-top: 5px;">评价</div>
  </div>
	<div class="clear"></div>
    ...
    <?php endif; ?>
        ...
        <!---<div style="text-align: center;display: none;margin-top: 5px;" class="tel-box">
            <div class="input-with-select el-input el-input--mini el-input-group el-input-group--append " style="width: 130px; float: center;">
...
<script>
 $("#exportchat").bind("click",()=>window.location.href=exporturl); //绑定导出记录url
function phone(){
...
<script type="text/javascript" src="/assets/js/moblie/mochat.js?t=1"></script>
<script>
                                ...
                                //alert(result.address);
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(res){
                                            ...
                                            var str =   getOuterRight({pic:'我',cid:'00',is_read:0,content: locationmessage, time: formattingTime(new Date())})
// let name = '';
//   if(v.is_read==1){
//     name="已读";
//   }else if(v.is_read==0){
...
//             <img class="my-circle" src="${pic}" width="35px" height="35px">
//         </div>
//         <div class="outer-right">
//             <pre id='cid${cid}' class='noredcustomer'>${name}</pre>
//             <div class="msg_body">
//                 <span style="color: #aca7a7;">${time}</span>
//                 <div class="customer">
//                     <pre>${locationmessage}</pre>
//                 </div>
//             </div>
//         </div>
//     </li>
// `;
    ...
    var recOpen=function(){
        ...
        recBlob=null;
        rec=Recorder({
            type:"wav",sampleRate:16000,bitRate:16,a
                            ...
                            xhr.onreadystatechange = function () {
                                if (xhr.readyState == 4 && xhr.status == 200) {
                                  ...
                                  time =myDate.getFullYear()+"-"+(myDate.getMonth()+1)+"-"+myDate.getDate()+" "+myDate.getHours()+":"+myDate.getMinutes();
                                    ...
                                    var str = '';
                                    str += '<li class="chatmsg" style="display: unset">';
                                    str += `<div class='outer-right' style="flex-direction: column;align-items: end"><span>${time}</span><div class='customer'>`;
