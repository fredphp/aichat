                      ...
                      var moblieweb = encodeURI('{$url}{$this->base_root}/mobile/index/home?{$theme}visiter_id='+blzx.visiter_id+'&visiter_name='+blzx.visiter_name+'&avatar='+blzx.avatar+'&business_id={$business_id}&groupid='+groupid+'&product='+blzx.product);
                       ...
                       if(!s){
                            ...
                            {$xfbg}
                                                if(blzx.isMobile()){
                               div.style.width='100%';
                  div.innerHTML='<i class='blzx-close2\" onclick=\"tanchuang2()\"></i><iframe id=\"wolive-iframe\" src=\"'+web+'\" onload=\"pageOk()\"     allow=\"camera;microphone\"></iframe><div id=\"loading\"><img src=\"{$url}{$this->base_root}/assets/images/platform/loading-2.svg\"></div>'
                                document.body.appendChild(div);     
                           }
                                ...
                                if(!blzx.isMobile()){
                                    ...
                                    div.innerHTML='<i class=\"blzx-close\" onclick=\"tanchuang()\"></i><i class=\"blzx-close2\" onclick=\"tanchuang2()\"></i><iframe id=\"wolive-iframe\" src=\"+web+\"onload=\"pageOk()\"  allow=\"camera;microphone\"></iframe><div id=\"loading\"><img src=\"{$url}{$this->base_root}/assets/images/platform/loading-2.svg\"></div>'
                                          document.body.appendChild(div);
                            }
                       ...
                       if(!s){
                            ...
                            if(blzx.isMobile()){
                               ...
                               {$mheight}
                                                               ...
                                                               if(blzx.isMobile()){
                               div.style.width='100%';
                  div.innerHTML='<div id=\"loading\"><img src=\"{$url}{$this->base_root}/assets/images/platform/loading-2.svg\"></div>'
                                     document.body.appendChild(div);     
                           }
