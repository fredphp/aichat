...
--
-- Host: localhost    Database: cs_wmtao_xyz
-- ------------------------------------------------------
...
CREATE TABLE `wolive_admin_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=635 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='管理员登录日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4110 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='会话表(排队表)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wolive_service` VALUES (1,'admin','客服小朵','d8f7c2d2775869fb69b8757edcf6ae4f','1','','ozs4F6uPcpJjDh2LoLJUBvU0P6mE','',1,'/upload/images/1/1701418586.png','super_manager',0,0,'online'),(11,'ceshi','客服小美','489536d7c643d67993bff029d9620f02','2','312312','ozs4F6oK3J6507rhy-qmyFIt_AiU','111@qq.com',1,'/assets/images/admin/avatar-admin2.png','service',1,0,'online');
...
) ENGINE=InnoDB AUTO_INCREMENT=3746 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='微信公众号';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'cs_wmtao_xyz'
--

--
-- Dumping routines for database 'cs_wmtao_xyz'
--
...
-- Dump completed on 2025-02-11 17:45:59
