    ...
    if (debugs == "jpg" || debugs == "gif" ||debugs == "png" ||debugs == "jpeg") {
        ...
        $("#picture").ajaxSubmit({
            ...
            success: function (res) {
                ...
                if(res.code == 0){
                    var str = getOuterRight({content:res.data,time:formattingTime(new Date())})
        ...
        $("#picture1").ajaxSubmit({
            ...
            success: function (res) {
                ...
                if(res.code == 0){
                    ...
                    var str = getOuterRight({msg:res.data,time:formattingTime(myDate)});
        ...
        $("#file").ajaxSubmit({
            ...
            success: function (res) {
                ...
                if(res.code == 0){
                  ...
                  str = getOuterRight({content:str,time:formattingTime(myDate)})
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            if(res.code == 0){
                ...
                var str='<p style="font-weight:blod;">'+guess_ask+'</p>'
                ...
                $.each(res.data,function(k,v){
                    ...
                    if ( v.keyword != '') {
                       ...
                       /* $("#question_key_list").append('<div class="keyword-item swiper-slide" onclick="getanswer(' + v.qid + ',`' + v.question + '`)">' + v.keyword + '</div>');*/
                             $("#question_key_list").append('      <a class="slideInRightItem"  onclick="getanswer(' + v.qid + ',`' + v.question + '`)" >' + v.keyword + '</a>');
                ...
                if (res.data.length<1){
                    $("#question_key_list").remove();
                }
                 str=getOuterLeft({nick_name:'系统',time:time,type:1,avatar:logo,content:str});
...
function gettishi(business_id){
    ...
    $.ajax({
     ...
     setTimeout('var div = document.getElementById("wrap");div.scrollTop = div.scrollHeight;',600)
        ...
        setTimeout(()=>{
            console.log(document.getElementById("chat-message-warring-audio"))
            document.getElementById("chat-message-warring-audio").play()
        },1500)
...
function getanswer(id,question){
    ...
    var str = getOuterRight({content:question,time:formattingTime(new Date())})
...
var send = function () {
    ...
    if (msg == '' || $.cookie("service") == '') {
        ...
        var str  =  getOuterRight({content:msg2,time:formattingTime(new Date()),is_read:0,cid: '00'})
